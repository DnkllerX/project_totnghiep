...
public class ShareIssue {
    ...
    private BigDecimal issuePrice;   // nullable neu DIVIDEND
    ...
    /** DIVIDEND: issue_price phai NULL | ISSUE: issue_price phai > 0 (khop CHECK constraint) */
    public boolean isPriceValid() {
        if (issueType == IssueType.DIVIDEND) return issuePrice == null;
        if (issueType == IssueType.ISSUE) return issuePrice != null && issuePrice.signum() > 0;
        return false;
    }
