...
<%@ include file="/WEB-INF/views/common/ga4.jsp" %>
    ...
    <title>Đăng ký tài khoản - VinScape</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* --- UIVERSE CSS STYLES CHO REGISTER (Form to hơn để chứa nhiều trường) --- */
        main {
        ...
        .form-container::-webkit-scrollbar-thumb { background: rgba(55, 65, 81, 1); border-radius: 3px; }

        .title {
            text-align: center; font-size: 1.5rem; line-height: 2rem; font-weight: 700;
        }
        .subtitle {
            text-align: center; font-size: 0.8rem; color: rgba(156, 163, 175, 1); margin-top: 4px;
        }
        ...
        .input-group { margin-top: 0.25rem; font-size: 0.875rem; line-height: 1.25rem; }
        ...
        .sign {
            ...
            margin-top: 1rem; transition: opacity 0.2s, box-shadow 0.2s, transform 0.15s;
        ...
        .signup a { color: rgba(243, 244, 246, 1); text-decoration: none; font-size: 13px; }
...
<main>
    <div class="form-container">
        <p class="title">Đăng Ký Cổ Đông</p>
        <p class="subtitle">Tài khoản cần ADMIN duyệt trước khi sử dụng</p>

        <c:if test="${not empty error}"><div class="alert alert-error"><c:out value="${error}"/></div></c:if>
        <c:if test="${not empty success}"><div class="alert alert-success"><c:out value="${success}"/></div></c:if>

        <form class="form" method="post" action="${pageContext.request.contextPath}/register" autocomplete="off">
            <div class="form-grid">
                ...
                <div class="input-group field-full">
                    ...
                    <div style="height:3px; background:#374151; margin-top:6px; border-radius:2px; overflow:hidden;">
                        <div id="registerPasswordBar" style="height:100%; width:0%; transition:width .3s ease, background .3s ease;"></div>
                    </div>
                    <div id="registerPasswordLabel" style="font-size:11px; color:#9ca3af; margin-top:4px; text-align:right;"></div>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="date" name="birthDate" style="color-scheme: dark;">
                </div>
                <div class="input-group field-full">
