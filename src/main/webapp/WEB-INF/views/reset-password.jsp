...
<%@ include file="/WEB-INF/views/common/ga4.jsp" %>
    ...
    <title>Đặt lại mật khẩu - VinScape</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hint { font-size: 11px; color: rgba(156, 163, 175, 1); margin-top: 4px; }
        .sign {
...
<div class="form-container">
    ...
    <c:if test="${not empty token}">
        <form class="form" method="post" action="${pageContext.request.contextPath}/reset-password" autocomplete="off">
            ...
            <p class="hint">Tối thiểu 8 ký tự, gồm cả chữ và số.</p>

            <button type="submit" class="sign">Đặt lại mật khẩu</button>
        </form>
    </c:if>

    <p class="signup">
        <a href="${pageContext.request.contextPath}/login">Quay lại đăng nhập</a> |
        <a href="${pageContext.request.contextPath}/forgot-password">Yêu cầu link mới</a>
    </p>
</div>
